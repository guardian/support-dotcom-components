...
const EoyMomentBanner = getMomentTemplateBanner({
...
const unvalidated = bannerWrapper(EoyMomentBanner, 'eoy-banner');
const validated = validatedBannerWrapper(EoyMomentBanner, 'eoy-banner');

export { validated as EoyMomentBanner, unvalidated as EoyMomentBannerUnvalidated };

...
const ChoiceCardsBanner = bannerWrapper(
...
const ChoiceCardsBannerTemplate: Story<BannerProps> = (props: BannerProps) => (
    <ChoiceCardsBanner {...props} />
);

export const ChoiceCards = ChoiceCardsBannerTemplate.bind({});
ChoiceCardsBannerTemplate.args = {
    ...props,
    content: {

...
const ChoiceCardsBanner = getMomentTemplateBanner({
    containerSettings: {
...
const unvalidated = bannerWrapper(ChoiceCardsBanner, 'ukraine-moment-banner');
const validated = validatedBannerWrapper(ChoiceCardsBanner, 'ukraine-moment-banner');

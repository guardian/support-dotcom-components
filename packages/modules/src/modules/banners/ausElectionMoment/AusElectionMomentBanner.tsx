...
const AusElectionBanner = getMomentTemplateBanner({
...
const unvalidated = bannerWrapper(AusElectionBanner, 'aus-moment-banner');
const validated = validatedBannerWrapper(AusElectionBanner, 'aus-moment-banner');

export { validated as AusElectionBanner, unvalidated as AusElectionBannerUnvalidated };

...
const styles = {
	...
	reminderLine: css`
		...
		${from.leftCol} {
			left: calc(
				50% - 550px + 1120px * 0.14285714285714285 - 20px + 10px + 1px
			);
		}
			...
			<Container>
				...
				<div css={styles.leftCol}>
					<Columns>
						...
						<Column width={4 / columnCounts.leftCol}>
							{buttons}
						</Column>
					</Columns>
				</div>
...
export {
	validated as ContributionsBanner,
	unvalidated as ContributionsBannerUnvalidated,
};

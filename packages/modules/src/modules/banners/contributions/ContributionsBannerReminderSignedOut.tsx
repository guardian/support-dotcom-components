	...
	return (
		<div css={bodyContainerStyles}>
			...
			<div css={infoCopyContainerStyles}>
				We will send you a maximum of two emails in {reminderLabel}. To
				find out what personal data we collect and how we use it, view
				our{' '}
				<a
	...
	return (
		<div css={bodyContainerStyles}>
			...
			<div css={thankyouBodyStyles}>
				...
				messsage in your inbox in {reminderLabel}. If you have any

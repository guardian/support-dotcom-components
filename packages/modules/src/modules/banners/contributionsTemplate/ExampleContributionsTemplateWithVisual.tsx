		...
		copy={
			<>
				<Hide above="tablet">
					...
					Lorem ipsum dolor sit ame lorem ipsum dolor
				</Hide>
				<Hide below="tablet">
					Lorem ipsum dolor sit amet, consectetur adipiscing elit.
					Vivamus enim porttitor dolor at fermentum ut. Placerat est
					fermentum nulla porttitor est suspendisse proin volutpat.
					Habitant maecenas massa ullamcorper volutpat. Elit proin
					Placerat est fermentum nulla porttitor est suspendisse
					suspendisse porttitor est
				</Hide>
			</>
		}
	/>
...
export const ExampleWithTicker: React.FC<BannerProps> = ({
	tickerSettings,
}: BannerProps) => {
	return (
		<ContributionsTemplateWithVisual

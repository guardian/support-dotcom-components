...
const ChoiceCardsButtonsMomentBanner = bannerWrapper(
...
const ChoiceCardsButtonsMomentTemplate: Story<BannerProps> = (props: BannerProps) => (
    <ChoiceCardsButtonsMomentBanner {...props} />
);

export const ChoiceCardsMoment2023 = ChoiceCardsButtonsMomentTemplate.bind({});

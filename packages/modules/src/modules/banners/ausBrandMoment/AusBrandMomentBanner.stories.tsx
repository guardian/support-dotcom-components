...
import { getAusBrandMomentBanner } from './AusBrandMomentBanner';
...
export default {
    title: 'Banners/AusBrandMoment',
    args: props,
} as Meta;

const GreyBanner = bannerWrapper(
    getAusBrandMomentBanner({
...
const TwoCtasTemplate: Story<BannerProps> = (props: BannerProps) => <GreyBanner {...props} />;

export const TwoCtas = TwoCtasTemplate.bind({});
...
const RemindersTemplate: Story<BannerProps> = (props: BannerProps) => <GreyBanner {...props} />;

export const Reminders = RemindersTemplate.bind({});

Reminders.args = {
    ...TwoCtas.args,
    content: {
        ...TwoCtas.args.content,
        secondaryCta: {
            type: SecondaryCtaType.ContributionsReminder,
        },
    },
    mobileContent: {
        ...TwoCtas.args.mobileContent,
        secondaryCta: {
            type: SecondaryCtaType.ContributionsReminder,
        },
    },

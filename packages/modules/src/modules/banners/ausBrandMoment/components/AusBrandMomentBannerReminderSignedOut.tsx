...
export interface AusBrandMomentBannerReminderSignedOutProps {
...
export function AusBrandMomentBannerReminderSignedOut({
    reminderCta,
    reminderStatus,
    onReminderSetClick,
    setReminderCtaSettings,
}: AusBrandMomentBannerReminderSignedOutProps): JSX.Element {

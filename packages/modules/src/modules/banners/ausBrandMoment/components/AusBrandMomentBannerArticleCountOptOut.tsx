...
export interface AusBrandMomentArticleCountOptOutProps {
    numArticles: number;
    nextWord: string | null;
    settings: BannerTemplateSettings;
}

export const AusBrandMomentArticleCountOptOut: React.FC<AusBrandMomentArticleCountOptOutProps> = ({
    numArticles,
    nextWord,
    settings,
}: AusBrandMomentArticleCountOptOutProps) => {

...
import { UsEoyMomentGivingTuesdayBanner } from './UsEoyMomentGivingTuesdayBanner';
import { props } from '../utils/storybook';
import { BannerProps, SecondaryCtaType, TickerCountType, TickerEndType } from '@sdc/shared/types';

export default {
    component: UsEoyMomentGivingTuesdayBanner,
    title: 'Banners/UsEoyMomentGivingTuesday',
    args: props,
} as Meta;

const Template: Story<BannerProps> = (props: BannerProps) => (
    <UsEoyMomentGivingTuesdayBanner {...props} />
);
...
WithoutArticleCount.args = {
    ...props,
    mobileContent: {
        heading: 'They’re still at it, but so are we.',
        messageText:

...
type DesignableMomentBannerTickerProps = {
    tickerSettings: TickerSettings;
    stylingSettings: TickerStylingSettings;
};

const DesignableMomentBannerTicker: React.FC<DesignableMomentBannerTickerProps> = ({
    tickerSettings,
    stylingSettings,
}: DesignableMomentBannerTickerProps) => {
...
export default DesignableMomentBannerTicker;

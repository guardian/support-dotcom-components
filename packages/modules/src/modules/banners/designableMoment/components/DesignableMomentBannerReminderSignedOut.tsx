...
export interface DesignableMomentBannerReminderSignedOutProps {
...
export function DesignableMomentBannerReminderSignedOut({
    reminderCta,
    reminderStatus,
    onReminderSetClick,
    setReminderCtaSettings,
}: DesignableMomentBannerReminderSignedOutProps): JSX.Element {

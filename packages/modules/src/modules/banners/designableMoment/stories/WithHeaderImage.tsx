...
import { getDesignableMomentBanner } from '../DesignableMomentBanner';

export const BannerWithHeaderImage = bannerWrapper(
    getDesignableMomentBanner({
        containerSettings: {
...
export const BannerWithHeaderImageTemplate: Story<BannerProps> = (props: BannerProps) => (

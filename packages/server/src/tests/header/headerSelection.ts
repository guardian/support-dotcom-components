...
const isLastOneOffContributionWithinLast2To13Months = (
	...
	return (
		monthsSinceLastContribution >= 2 && monthsSinceLastContribution <= 13
	);
};
...
const isAusMoment = (countryCode: string): boolean =>
	countryCode === 'AU' && isAusMomentLive();
...
export const selectHeaderTest = (
	...
	const select = (): HeaderTest => {
		const lastContributed2To13MonthsAgo =
			isLastOneOffContributionWithinLast2To13Months(

...
export const newsletterEpicTest: EpicTest = {
    ...
    status: 'Live',
    locations: ['GBPCountries', 'UnitedStates', 'AUDCountries', 'EURCountries', 'International', 'NZDCountries', 'Canada'],
    audience: 1,
    tagIds: [],
    sections: [],
    excludedTagIds: [],
...
/*
Test 4    A special purpose editorial newsletter will generate sign ups/revenue than a contribution    Current epic - football cartoon    The Fiver    AV/Impression - need to backwards calc value of newsletters based on email -->    "Low engaged users: <=2 pageviews per month

Region: Global

Sections: Football tag only"    <iframe src="https://www.theguardian.com/email/form/plaintone/rrcp-epic/4163" height="52px" data-form-title="Sign up for The Fiver“ data-form-description="Get our daily email on the world of football" data-form-campaign-code="Fiver_signup_page" scrolling="no" seamless frameborder="0" class="iframed--overflow-hidden email-sub__iframe js-email-sub__iframe js-email-sub__iframe--article" data-form-success-desc="Thanks for signing up"></iframe>    Current epic - football cartoon    "Sign up to the Fiver
...
export const epicLenoreWithImageTest_AUS: EpicTest = {
    ...
    excludedTagIds: [
        ...
        'world/cost-of-living-crisis',
        'society/poverty',
        'series/global-cost-of-living-crisis',
        'business/inflation',
        'global-development/food-security',
        'us-news/us-capital-breach',
        'us-news/donaldtrump',
        'world/russia',
        'world/ukraine',
        'world/abortion',
        ...
        'society/women',
        'global-development/womens-rights-and-gender-equality',
        'football/football',

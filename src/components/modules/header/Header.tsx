...
import {HeaderProps, HeaderTracking} from "../../../types/HeaderTypes";
...
export const Header: React.FC<HeaderProps> = (props: HeaderProps) => {
    ...
    const addTracking = (baseUrl: string): string => addRegionIdAndTrackingParamsToSupportUrl(
        baseUrl,
        props.tracking,
        props.countryCode
    );
